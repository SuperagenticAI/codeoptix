...
class TestCLICommands:
    ...
    def test_cli_main_group(self):
        ...
        assert "CodeFlect" in result.output
    ...
    @patch("codeflect.cli.create_adapter")
    @patch("codeflect.cli.create_llm_client")
    @patch("codeflect.cli.EvaluationEngine")
    def test_eval_command_structure(
        self, mock_eval_engine, mock_llm_client, mock_adapter
    ):
