...
from tests.conftest import sample_evaluation_results, temp_artifacts_dir
...
class TestArtifactManager:
    ...
    def test_load_results(self, temp_artifacts_dir, sample_evaluation_results):
        ...
        saved_path = manager.save_results(sample_evaluation_results, run_id=sample_evaluation_results["run_id"])
    ...
    def test_save_results_returns_path(self, temp_artifacts_dir, sample_evaluation_results):
        ...
        manager = ArtifactManager(artifacts_dir=temp_artifacts_dir)
        path = manager.save_results(sample_evaluation_results, run_id=sample_evaluation_results["run_id"])
    ...
    def test_save_reflection(self, temp_artifacts_dir, sample_evaluation_results):
        ...
        path = manager.save_reflection(reflection_content, run_id=sample_evaluation_results["run_id"])
