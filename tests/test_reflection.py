...
class TestReflectionEngine:
    ...
    def test_reflect_saves_to_file(self, temp_artifacts_dir, sample_evaluation_results):
        ...
        # Save results first
        artifact_manager.save_results(sample_evaluation_results, run_id=sample_evaluation_results["run_id"])
    ...
    def test_reflect_from_run_id(self, temp_artifacts_dir, sample_evaluation_results):
        ...
        # Save results
        artifact_manager.save_results(sample_evaluation_results)
        
        reflection = engine.reflect_from_run_id(sample_evaluation_results["run_id"])
