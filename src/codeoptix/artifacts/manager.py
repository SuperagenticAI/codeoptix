...
class ArtifactManager:
    """Manages storage and retrieval of CodeFlect artifacts."""
    ...
    def __init__(self, artifacts_dir: Optional[str | Path] = None):
        ...
        Args:
            artifacts_dir: Directory for storing artifacts (default: .codeflect/artifacts)
        """
        if artifacts_dir is None:
            artifacts_dir = Path(".codeflect") / "artifacts"
