...
from codeoptix.vendor.bloom.utils import litellm_chat
...
class BloomIdeationIntegration:
    ...
    def _call_llm_with_bloom_format(
        self,
        system_prompt: str,
        user_prompt: str
    ) -> str:
        ...
        This bridges CodeFlect's LLM client with Bloom's expected interface.
        """
        # Use CodeFlect's LLM client, but format for Bloom compatibility
        messages = [
    ...
    def _extract_scenario_from_text(
        self,
        text: str,
        behavior_name: str
