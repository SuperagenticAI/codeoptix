"""Evaluation components for CodeFlect."""
...
class StaticAnalyzer:
    ...
    def analyze(self, code: str, output_path: Optional[Path] = None) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            results["errors"].append(f"Bandit error: {str(e)}")
        finally:
            # Clean up
            temp_file.unlink()
...
"""
        ...
        try:
            ...
            if "EVIDENCE:" in response:
                ...
                result["evidence"] = [line.strip() for line in evidence_section.split('\n') if line.strip() and not line.strip().startswith('-')]
