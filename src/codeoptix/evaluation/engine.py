...
from codeoptix.behaviors import create_behavior, BehaviorSpec
...
class EvaluationEngine:
    ...
    def evaluate_behaviors(
        ...
        for behavior_name in behavior_names:
            try:
                behavior = create_behavior(behavior_name, self.config.get("behaviors", {}).get(behavior_name, {}))
    ...
    def _generate_scenarios_for_behaviors(
        self,
        behavior_names: List[str]
    ) -> List[Dict[str, Any]]:
