...
This example demonstrates the full CodeFlect workflow for a specific behavioral spec:
...
def main():
    ...
    print("=" * 70)
    print("CodeFlect: Behavioral Spec Example - Code Security")
    ...
    try:
        ...
        code_snippet = agent_output.code[:200] + "..." if len(agent_output.code) > 200 else agent_output.code
        print("Code snippet:")
        print(code_snippet)
        print()
...
conn = psycopg2.connect(
    ...
    if not evaluation_results.passed:
        print(f"  - Evolved Prompts: {artifact_manager.get_evolved_prompts_path(full_results['run_id'])}")
    print()
    print("=" * 70)
